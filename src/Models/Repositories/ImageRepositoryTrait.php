...
trait ImageRepositoryTrait
{
     ...
     * @return Array
     */
    public function packRecord($record, $code, $is_frontend = false): array
    {
        if (is_array($code)) {
            $list = [];
     ...
     * @return Array
     */
    public function getlist($records, $code, $is_frontend = false): array
    {
        $list = [];
        if (is_array($code)) {
    ...
    */
     ...
     * @return Array
     */
    public function getlistOfIcons($code, ?bool $is_enabled, $instance = null, $is_frontend = false): array
    {
     ...
     * @return Array
     */
    public function getEnabledIcon($code, $instance, ?string $type, $is_frontend = false): array
    {
        $records = $instance->icons()->where('is_visible', 1)
                                     ->where('is_enabled', 1)
    ...
    */
     ...
     * @return Array
     */
    public function getlistOfLogos($code, ?bool $is_enabled, $instance = null, $is_frontend = false): array
    {
        $instance = $instance ? $instance : $this->instance;
     ...
     * @return Array
     */
    public function getEnabledLogo($code, $instance, ?string $type, $is_frontend = false): array
    {
        $records = $instance->logos()->where('is_visible', 1)
                                     ->where('is_enabled', 1)
                                     ->orderBy('updated_at', 'DESC')
    ...
    */
     ...
     * @return Array
     */
    public function getlistOfCovers($code, ?bool $is_enabled, $instance = null, $is_frontend = false): array
    {
        $instance = $instance ? $instance : $this->instance;
     ...
     * @return Array
     */
    public function getEnabledCover($code, $instance, ?string $type, $is_frontend = false): array
    {
        $records = $instance->covers()->where('is_visible', 1)
                                      ->where('is_enabled', 1)
                                      ->orderBy('updated_at', 'DESC')
    ...
    */
     ...
     * @return Array
     */
    public function getlistOfImages($code, $is_onlySimple = false, ?bool $is_enabled, $instance = null, $is_frontend = false): array
    {
        $instance = $instance ? $instance : $this->instance;
